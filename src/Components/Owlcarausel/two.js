           ...
           return (
            <div className="item" >
                        <div className="item-box" >
                            ...
                            <NavLink  to={"/OpticalLensDetails/" +_id}>    <img src={productPic[0]} alt=''   style={{height:"250px",width:"100%"}} className="img-fluid "/></NavLink>
                            ...
                            <p className="prod-name text-center" style={{paddingTop:"9px"}}>{name}</p>
